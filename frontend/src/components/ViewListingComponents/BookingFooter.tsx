...
export default function BookingFooter ({ price, openDateModal }: BookingModalProps) {
  ...
  return (
    <footer className="w-full border-t border-black xl:hidden flex justify-between p-5 items-center fixed bottom-0 bg-white left-0">
      <div>
        ...
        <button className='underline text-lg font-semibold' onClick={openDateModal}>{checkinDate} - {checkoutDate}</button>
      </div>
