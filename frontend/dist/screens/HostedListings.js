...
export default function HostedListngs(_a) {
    ...
    var _h = useState(0), unpublishedListingId = _h[0], setUnpublishedListingId = _h[1];
    var _j = useState(false), unpublishedListingOpen = _j[0], setUnpublishedListingOpen = _j[1];
    ...
    var openUnpublishListingModal = function (listingId) {
        setUnpublishedListingId(listingId);
        setUnpublishedListingOpen(true);
    };
    var navigate = useNavigate();
    var navigateToViewBookings = function (listingId) {
        navigate("/listings/bookings/".concat(listingId));
    };
    useEffect(function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-15 lg:max-w-7xl lg:px-8' },
            React.createElement(HostedBreadcrumbs, null),
            React.createElement("div", { className: 'flex flex-row justify-between' },
                ...
                React.createElement(NavLink, { "data-cy": 'create-listing', to: '/listings/create', className: 'inline-flex items-center rounded-md bg-blue-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' }, "Add New Listing")),
            React.createElement("div", { className: 'my-3' },
                ...
                React.createElement("ul", { role: 'list', className: 'divide-y divide-gray-100' }, myListings.map(function (listings) { return (React.createElement("li", { key: listings.id, className: 'flex flex-col gap-3 justify-between gap-x-6 py-5 sm:flex-row' },
                    React.createElement("div", { className: 'flex min-w-0 gap-x-4' },
                        React.createElement("img", { className: 'h-12 w-12 flex-none rounded-full bg-gray-50', src: listings.thumbnail, alt: "listing thumbnail" }),
                    ...
                    React.createElement("div", { className: 'flex flex-row   shrink-0 gap-3 justify-center items-end sm:flex-col' },
                        React.createElement(NavLink, { to: "/listings/edit/".concat(listings.id), type: 'button', "data-cy": 'edit-listing', className: 'inline-flex items-center rounded-md ring-1 ring-blue-500 px-3 py-2 text-xs font-semibold text-blue-500 shadow-sm hover:bg-blue-50 focus-visible:outline focus-visible:outline-1 focus-visible:ring-offset-1 focus-visible:ring-blue-600 sm:text-sm' }, "Edit Listing"),
                        React.createElement("button", { type: 'button', disabled: !listings.published, onClick: function () { return navigateToViewBookings(listings.id); }, name: 'view-bookings', className: 'inline-flex items-center rounded-md ring-1 ring-green-700 px-3 py-2 text-xs font-semibold text-green-700 shadow-sm hover:bg-blue-50 focus-visible:outline focus-visible:outline-1 focus-visible:ring-offset-1 focus-visible:ring-green-800 sm:text-sm disabled:bg-white disabled:opacity-50' }, "View Bookings"),
                        listings.published
                            ? (React.createElement("button", { name: 'unpublish-listing', onClick: function () { return openUnpublishListingModal(listings.id); }, className: 'inline-flex items-center rounded-md ring-1 ring-red-500 px-3 py-2 text-xs font-semibold text-red-500 shadow-sm hover:bg-red-50 focus-visible:outline focus-visible:outline-1 focus-visible:ring-offset-1 focus-visible:ring-red-600 sm:text-sm' }, "Unpublish Listing"))
                            : (React.createElement("button", { name: 'publish-listing', onClick: function () { return openPublishListingModal(listings.id); }, className: 'inline-flex items-center rounded-md ring-1 ring-blue-500 px-3 py-2 text-xs font-semibold text-blue-500 shadow-sm hover:bg-blue-50 focus-visible:outline focus-visible:outline-1 focus-visible:ring-offset-1 focus-visible:ring-blue-600 sm:text-sm' }, "Publish Listing")),
                        React.createElement("button", { type: 'button', onClick: function () { return openDeleteListingModal(listings.id); }, className: 'inline-flex items-center rounded-md bg-red-500 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-red-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 sm:text-sm' }, "Delete Listing")))); })))),
        ...
        React.createElement(UnpublishListingModal, { open: unpublishedListingOpen, setOpen: setUnpublishedListingOpen, listingId: unpublishedListingId, setErrorMessage: setErrorMessage, setErrorModalOpen: setErrorModalOpen, setRunEffect: setRunEffect })));
}
