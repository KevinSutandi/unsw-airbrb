...
export default function BookConfirmation(_a) {
                ...
                React.createElement(Transition.Child, { as: Fragment, enter: "ease-out duration-300", enterFrom: "opacity-0 scale-95", enterTo: "opacity-100 scale-100", leave: "ease-in duration-200", leaveFrom: "opacity-100 scale-100", leaveTo: "opacity-0 scale-95" },
                    React.createElement(Dialog.Panel, { className: "relative w-full max-w-sm p-6 bg-white rounded-lg shadow-xl" },
                        ...
                        React.createElement("div", null,
                            React.createElement(Dialog.Title, { as: "h3", className: "text-lg font-semibold leading-6 text-gray-900 mt-4" }, "Hooray!!")),
                        React.createElement("div", { className: "mt-3" },
                            React.createElement("p", { className: "text-sm text-gray-500" }, "Booking Request Sent!")),
                        React.createElement("div", { className: "mt-6" },
                            React.createElement("div", { className: "confirmation-bar" },
                                React.createElement("div", { className: "confirmation" })))))))));
}
//# sourceMappingURL=BookConfirmation.js.map