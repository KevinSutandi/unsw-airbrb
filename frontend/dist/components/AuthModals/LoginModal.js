                    ...
                    React.createElement(Dialog.Panel, { className: "relative w-full max-w-sm p-6 bg-white rounded-lg shadow-xl" },
                        ...
                        React.createElement("div", { className: "mt-6" },
                            React.createElement("form", { className: "space-y-4", onSubmit: handleLogin },
                                ...
                                React.createElement("div", null,
                                    React.createElement("button", { type: "submit", className: "w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400" }, "Login")))),
                        React.createElement("div", { className: "mt-6" },
