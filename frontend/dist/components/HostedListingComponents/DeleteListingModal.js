...
export default function DeleteListing(_a) {
    var _this = this;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, makeRequest('DELETE', "listings/".concat(listingId), { token: token })];
                case 2:
                    // Make a DELETE request to delete the listing
                    _b.sent();
                ...
                case 3:
                    ...
                    if (axios.isAxiosError(err_1)) {
                        if ((_a = err_1.response) === null || _a === void 0 ? void 0 : _a.data) {
                            ...
                            console.error('Delete failed:', err_1.response.data.error);
                        }
                    }
                    else {
                        setErrorMessage('An unexpected error occurred.');
                        console.error('Delete failed:', err_1);
                    }
                    return [3 /*break*/, 4];
                            ...
                            React.createElement("div", { className: 'bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4' },
                                React.createElement("div", { className: 'sm:flex sm:items-start' },
                                    React.createElement("div", { className: 'mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10' },
                                        React.createElement(TrashIcon, { className: 'h-6 w-6 text-red-600', "aria-hidden": 'true' })),
                                    React.createElement("div", { className: 'mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left' },
                                        React.createElement(Dialog.Title, { as: 'h3', className: 'text-base font-semibold leading-6 text-gray-900' }, "Delete Listing"),
                                        React.createElement("div", { className: 'mt-2' },
                                            React.createElement("p", { className: 'text-sm text-gray-500' }, "Are you sure you want to delete this Listing"))))),
                            React.createElement("div", { className: 'bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6' },
                                React.createElement("button", { type: 'button', className: 'inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto', onClick: function () { return handleDelete(); } }, "Delete"),
...
//# sourceMappingURL=DeleteListingModal.js.map