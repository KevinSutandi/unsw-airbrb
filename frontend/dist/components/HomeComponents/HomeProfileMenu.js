                    ...
                    React.createElement("div", { className: "px-1 py-1 " }, isLoggedIn
                        ? (React.createElement(React.Fragment, null,
                            React.createElement(Menu.Item, null, function (_a) {
                                ...
                                return (React.createElement("button", { className: "".concat(active ? 'bg-blue-500 text-white' : 'text-gray-900', " group flex w-full items-center rounded-md px-2 py-2 text-sm font-bold"), onClick: navigateHostedListings, name: 'view-listings' }, "View Listings"));
                            }),
                            React.createElement("hr", null),
                            React.createElement(Menu.Item, null, function (_a) {
                                var active = _a.active;
                                return (React.createElement("button", { onClick: handleLogout, className: "".concat(active ? 'bg-blue-500 text-white' : 'text-red-500', " group flex w-full items-center rounded-md px-2 py-2 text-sm"), name: 'logout' }, "Log out"));
                            })))
                        : (React.createElement(React.Fragment, null,
                            React.createElement(Menu.Item, null, function (_a) {
                                var active = _a.active;
                                return (React.createElement("button", { className: "".concat(active ? 'bg-blue-500 text-white' : 'text-gray-900', " group flex w-full items-center rounded-md px-2 py-2 text-sm font-bold"), onClick: openRegisterModal, name: 'register' }, "Sign up"));
                            }),
                            React.createElement(Menu.Item, null, function (_a) {
                                var active = _a.active;
                                return (React.createElement("button", { onClick: openLoginModal, className: "".concat(active ? 'bg-blue-500 text-white' : 'text-gray-900', " group flex w-full items-center rounded-md px-2 py-2 text-sm"), name: 'login' }, "Login"));
                            })))))))));
}
