...
describe('Home Components Not Logged In', function () {
    var navbarSetup = function (isLoggedIn) {
        ...
        render(React.createElement(BrowserRouter, null,
            React.createElement(NavBar, { isLoggedIn: isLoggedIn, setIsLoggedIn: setIsLoggedIn, setErrorMessage: setErrorMessage, setErrorModalOpen: setErrorModalOpen, product: products, setProduct: setProducts, setIsFiltered: jest.fn() })));
    ...
    it('Log out', function () {
        var handleLogout = profileIconSetup(true).handleLogout;
        var logoutButton = screen.getByRole('menuitem', { name: /log out/i });
