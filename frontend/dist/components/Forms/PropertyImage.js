...
export default function PropertyImage(_a) {
    ...
    return (React.createElement("div", { className: "items-center flex" },
        React.createElement("div", { className: "relative" },
            React.createElement("img", { className: "object-scale-down rounded-md", "data-cy": "property-image", src: src }),
            React.createElement("button", { onClick: function () { return deletePropertyImage(idx); }, "aria-label": "delete image" },
