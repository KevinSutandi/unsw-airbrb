    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "mt-2 flex justify-between w-full items-center" },
            React.createElement("div", null,
                React.createElement("input", { type: "date", "data-cy": "fromDate-".concat(idx), value: fromValue, name: 'fromDate', className: "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ", placeholder: "Select date", onChange: function (e) { return handleDateChange(idx, 'from', e.target.value); } })),
            React.createElement("div", null, "To"),
            React.createElement("div", null,
                React.createElement("input", { type: "date", "data-cy": "toDate-".concat(idx), value: toValue, name: 'toDate', className: "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5", placeholder: "Select date", onChange: function (e) { return handleDateChange(idx, 'to', e.target.value); } })),
