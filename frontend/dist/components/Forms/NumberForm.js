...
var NumberForm = function (_a) {
    ...
    return (React.createElement("input", { type: 'number', name: name, id: id, min: min, max: max, value: value, autoComplete: autoComplete, onChange: handleInputChange, disabled: disabled, className: combinedClassName }));
};
