    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'flex flex-col p-5 gap-3 justify-center lg:flex-row' },
            React.createElement("div", { className: 'flex flex-col gap-3 justify-center items-center' },
                ...
                React.createElement(Calendar, { selectedDay: checkIn, setSelectedDay: setCheckIn })),
            ...
            React.createElement("div", { className: 'flex flex-col gap-3 justify-center items-center' },
                ...
                React.createElement(Calendar, { selectedDay: checkOut, setSelectedDay: setCheckOut, checkIn: checkIn }))),
