...
function SearchForm(_a) {
    ...
    return (React.createElement("form", null,
        ...
        React.createElement("div", { className: "relative" },
            ...
            React.createElement("button", { type: "submit", onClick: function (e) { filterTitleCity(e); }, className: "text-white absolute end-2.5 bottom-2.5 bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2" }, "Search")),
