...
export default function Calendar(_a) {
    var selectedDay = _a.selectedDay, setSelectedDay = _a.setSelectedDay, checkIn = _a.checkIn;
            ...
            React.createElement("div", null,
                React.createElement("div", null,
                    ...
                    React.createElement("div", { className: 'grid grid-cols-7 mt-2 text-sm' }, days.map(function (day, dayIdx) { return (React.createElement("div", { key: day.toString(), className: classNames(dayIdx === 0 && colStartClasses[getDay(day)], 'py-1.5') },
                        React.createElement("button", { type: 'button', onClick: function () { return setSelectedDay(day); }, className: classNames(isEqual(day, selectedDay) && 'text-white', !isEqual(day, selectedDay) &&
                                isToday(day) &&
