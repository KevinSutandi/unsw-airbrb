...
export default function NavBar(_a) {
    var _this = this;
    var isLoggedIn = _a.isLoggedIn, setIsLoggedIn = _a.setIsLoggedIn, setErrorModalOpen = _a.setErrorModalOpen, setErrorMessage = _a.setErrorMessage, setProduct = _a.setProduct, setIsFiltered = _a.setIsFiltered, runEffect = _a.runEffect, setRunEffect = _a.setRunEffect;
    ...
    return (React.createElement("header", { className: "bg-white" },
        React.createElement("nav", { className: "mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8", "aria-label": "Global" },
            React.createElement("div", { className: "flex lg:flex-1" },
                React.createElement(NavLink, { className: "-m-1.5 p-1.5 flex hover:scale-105 ease-in duration-200 cursor-pointer", to: '/' },
                    React.createElement("span", { className: "sr-only" }, "AirBRB"),
                    React.createElement("img", { className: "h-10 w-auto", src: logo, alt: "logo" }),
            ...
            React.createElement(Popover.Group, { className: "lg:flex lg:gap-x-12" },
                React.createElement(Dropdown, { runEffect: runEffect, setProducts: setProduct, setIsFiltered: setIsFiltered })),
            React.createElement("div", { className: "flex lg:hidden" },
                React.createElement("button", { name: 'open-menu', type: "button", className: "-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700", onClick: function () { return setMobileMenuOpen(true); } },
            ...
            React.createElement("div", { className: "hidden lg:flex lg:flex-1 lg:justify-end items-center", "data-cy": "profile-menu" },
            ...
            React.createElement(Dialog.Panel, { className: "fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10" },
                React.createElement("div", { className: "flex items-center justify-between" },
                    React.createElement("a", { href: "#", className: "-m-1.5 p-1.5 flex" },
                        React.createElement("span", { className: "sr-only" }, "AirBRB"),
                        React.createElement("img", { className: "h-8 w-auto", src: logo, alt: "logo" }),
                ...
                React.createElement("div", { className: "mt-6 flow-root" },
                    React.createElement("div", { className: "-my-6 divide-y divide-gray-500/10" }, isLoggedIn
                        ...
                        : (React.createElement("div", { className: "py-6" },
                            React.createElement("button", { name: 'registerMobile', onClick: openRegisterModal, className: "-mx-3 block rounded-lg px-3 py-2.5 text-base font-bold leading-7 text-gray-900 hover:bg-gray-50" }, "Sign up"),
                            React.createElement("button", { name: 'loginMobile', onClick: openLoginModal, className: "-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50" }, "Log in"))))))),
